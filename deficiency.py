...
class DeficiencyConfig(Config):
    ...
    NUM_CLASSES = 1 + 4  # Background + deficiency
...
class DeficiencyDataset(utils.Dataset):
    ...
    def load_deficiency(self, dataset_dir, subset):
        ...
        self.add_class("deficiency", 1, "column")
        self.add_class("deficiency", 2, "spalling")
        self.add_class("deficiency", 3, "horizontal")
        self.add_class("deficiency", 4, "vertical")
        ...
        print("Total image: ", len(annotations))
        numofimage = [0, 0, 0, 0]
        ...
        for a in annotations:
            ...
            if type(a["regions"]) is dict:
                ...
                label_ids = [
                    label_dict[r["region_attributes"]["deficiency"]]
        ...
        print("Number of Label in Each Category", numofimage)
...
def train(model):
    ...
    dataset_train.load_deficiency(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = DeficiencyDataset()
    dataset_val.load_deficiency(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Train Mask R-CNN to detect Deficiency."
    )
