...
from .pda.mask_correction_page import MaskCorrectionPage
...
class PDAPage(QWidget):
    ...
    def __init__(self):
        ...
        self.mask_correction_page = MaskCorrectionPage()
        ...
        self.mask_correction_page.set_controller(self.controller)
        # The controller needs a reference to the views to send data back
        self.controller.set_view(self.analysis_page, self.mask_correction_page, self.report_page)

        # Add widgets to the stack
        self.stacked_widget.addWidget(self.damage_states_page)
        self.stacked_widget.addWidget(self.analysis_page)
        self.stacked_widget.addWidget(self.mask_correction_page)
        ...
        self.nav_list.addItem("Mask Correction")
